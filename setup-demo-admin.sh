#!/bin/bash
# Script to create demo admin user for testing (agent use)
# This script creates a demo admin user that can be used for automated testing
...
USERNAME="demo_admin"
PASSWORD="demo123"
EMAIL="demo_admin@voidtracker.com"
...
echo -e "${GREEN}👷 Creating Demo Admin Account: $USERNAME${NC}"
...
SELECT 
    gen_random_uuid(),
    '$USERNAME',
    '\$2a\$10\$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', -- demo123 encoded
    '$EMAIL',
    true,
    'ACTIVE',
    NOW(),
...
if [ -n "$TOKEN" ] && [ "$TOKEN" != "null" ]; then
    echo -e "${GREEN}✅ Login successful! Demo admin '$USERNAME' is ready.${NC}"
...
echo ""
echo -e "${GREEN}🎯 Demo Admin user '$USERNAME' is ready for testing!${NC}"
